...
angular.module('blogger.admin.services').value('API_ENDPOINT','http://spblogger-sitepointdemos.rhcloud.com/api/posts/:id'); // This is our end point
angular.module('blogger.admin.services').value('AUTH_ENDPOINT','http://spblogger-sitepointdemos.rhcloud.com/login');
angular.module('blogger.admin.services').value('LOGOUT_ENDPOINT','http://spblogger-sitepointdemos.rhcloud.com/logout');
